...
Release: 1%{?dist}
License: BSD
URL: http://www.taobao.org/tengine

Source0: https://www.taobao.org/tengine/download/tengine-%{tengine_version}.tar.gz
...
%description
Tengine 3.1.0 with systemd and dynamic module support.
...
%setup -q -n tengine-%{tengine_version}
